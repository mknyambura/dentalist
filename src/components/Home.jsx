    ...
    <div>
        ...
        <div className='flex flex-col items-center justify-center gap-8'>
            ...
            <div className='flex flex-col m-16 items-center'>
                ...
                <Link to='/services'>
                    <button className='text-[#583FBC] bg-[#583fbc1f] hover:bg-[#583FBC] hover:text-white rounded-lg font-bold flex flex-row justify-between px-8 py-4  items-center mt-24 gap-4'>

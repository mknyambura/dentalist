  ...
  return (
    <div>
        ...
        <div className='flex flex-row justify-between m-16'>
            <div className='flex flex-col w-[40%] justify-center text-start gap-14'>
        ...
        <div className='flex flex-col m-4'>
            <div className='relative bg-[#DBDEFA] flex flex-col gap-8 items-center m-16 rounded-[20px] h-[80vh]'>
                ...
                <h1 className='font-bold text-6xl'>We put the safety first</h1>
        ...
        <div className=' flex flex-col gap-8 mt-28 ml-8 mr-8 mb-16 justify-center'>
            <div className='flex flex-col items-center'>
                ...
                <h1 className='font-bold text-6xl mt-8'>Frequently asked questions</h1>
            </div>

            <div className='flex flex-col items-center gap-8'>
                <div className='flex flex-col relative w-1/2 bg-gradient-to-b from-[#DBEFFA] to-white'>
